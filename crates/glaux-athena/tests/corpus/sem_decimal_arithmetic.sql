...
SELECT 1.5 / 2 AS half_up, 1.0 / 3 AS third, 10.00 / 3 AS third_2dp, 100 / 3.0 AS int_over_dec,
       ...
       99999999999999999999999999999999999999 AS max_decimal, 99999999999999999999999999999999999999 - 1 AS max_decimal_minus_one,
       9223372036854775808 AS beyond_bigint, 1.5 % 1 AS dec_mod
FROM orders
WHERE id = 101
